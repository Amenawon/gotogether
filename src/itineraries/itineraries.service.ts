...
export class ItineraryService {
  ...
  async generateItinerary(request: GenerateItineraryDto): Promise<string> {
    ...
    
    {
      ...
      "best_time_to_visit": "Best time to visit the destination",
      "weather": "Typical weather during the visit",
      "currency": "Local currency",
      "language": "Primary language spoken",
      "local_cuisine": "Popular local dishes or food to try",
      "transportation": "Recommended transportation options",
      "safety_tips": "Safety tips for travelers",
        "itinerary": [
          {
            "day": 1,
            ...
            "activities": [
              {
                ...
                "image": "URL to an image of the activity"
              }
            ]
        }
      ]
