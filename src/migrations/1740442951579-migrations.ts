...
export class Migrations1740442951579 implements MigrationInterface {
  name = 'Migrations1740442951579';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."trips_status_enum" AS ENUM('Upcoming', 'Ongoing', 'Completed', 'Canceled')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."activities_category_enum" AS ENUM('Sightseeing', 'Food', 'Adventure', 'Relaxation', 'Shopping', 'Cultural')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "trips" ADD CONSTRAINT "FK_db768456df45322f8a749534322" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "flights" ADD CONSTRAINT "FK_c4cc80872be481805418bac5f6f" FOREIGN KEY ("tripId") REFERENCES "trips"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "destinations" ADD CONSTRAINT "FK_a2cb331f712897bbd7589fec670" FOREIGN KEY ("tripId") REFERENCES "trips"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "activities" ADD CONSTRAINT "FK_a05a503e997ca866e397aa4dfff" FOREIGN KEY ("tripId") REFERENCES "trips"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "activities" ADD CONSTRAINT "FK_1d7de8b3021172a447720f33230" FOREIGN KEY ("destinationId") REFERENCES "destinations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "activities" DROP CONSTRAINT "FK_1d7de8b3021172a447720f33230"`,
    );
    await queryRunner.query(
      `ALTER TABLE "activities" DROP CONSTRAINT "FK_a05a503e997ca866e397aa4dfff"`,
    );
    await queryRunner.query(
      `ALTER TABLE "destinations" DROP CONSTRAINT "FK_a2cb331f712897bbd7589fec670"`,
    );
    await queryRunner.query(
      `ALTER TABLE "flights" DROP CONSTRAINT "FK_c4cc80872be481805418bac5f6f"`,
    );
    await queryRunner.query(
